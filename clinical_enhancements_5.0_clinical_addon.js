...
function makeSection(){
 ...
 <div class="v5-card"><h3>⑧ DKA / BSA / 化疗</h3>
  <div class="v5-grid"><div><h4>DKA 短效胰岛素 CRI</h4><label>体重 kg<input id="r08DKAW" type="number" step=".01"></label><label>当前血糖 mmol/L<input id="r08DKAG" type="number"></label><label>本院 protocol 胰岛素 U/kg/h<input id="r08DKAR" type="number" step=".01"></label><label>目标血糖下降 mmol/L/h<input id="r08DKADrop" type="number" step=".1"></label><button class="primary" id="r08DKACalc">计算</button><div id="r08DKAOut"></div></div>
